...
namespace Cenappi.Cenappi_Data_Access.Entities
{
    ...
    [Migration("20240306134517_add configurators")]
    partial class addconfigurators
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cenappi.Cenappi_Data_Access.Model.DayConfigurator", b =>
                {
                    b.HasOne("Cenappi.Cenappi_Data_Access.Model.Day", "Days")
                        .WithMany()
                        .HasForeignKey("DaysId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Cenappi.Cenappi_Data_Access.Model.WeekConfigurator", null)
                        .WithMany("Days")
